...
<div class="toast">
		...
		<div class="alert alert-info alert-dismissible fade show" role="alert">
		  There are no Users that you are looking for
	...
	<c:if test="${list.size() != 0}">
		...
		<div class="accordion" id="accordionExample">
			<c:forEach var="v" items="${list }">
				<div class="card" >
		    		<div class="card-header" id="headingTwo" data-toggle="collapse" data-target="${v.getIdForHTML()}" aria-expanded="false" aria-controls="${v.userId }">
		      			<h5 class="mb-0">
		         			User Id : ${v.userId }
		      			</h5>
		      			<div>
		    		...
		    		<div id="${v.userId }" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
		      			<div class="card-body">
